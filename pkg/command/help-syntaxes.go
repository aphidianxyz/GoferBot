...
const (
	aboutSyntax string = "/about - describes GoferBot"
...
var allHelpSyntaxes = []string{aboutSyntax, helloSyntax, helpSyntax, pingSyntax, captionSyntax, captionImgSyntax, everyoneSyntax}
